...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    foreach ($_POST['attendance'] as $index => $status) {
        // Get the actual student using the index
...
if (file_exists($attendance_file) && !isset($success_message)) {
    displayAttendanceTakenPage($today);
    exit;
}

displayAttendancePage($today, $students, $success_message ?? null);

// Function definitions
function displayAttendanceTakenPage($today) {
    ?>
    <!DOCTYPE html>
    <html>
    <head>
        <title>Attendance Taken - Attendance System</title>
        <style><?php echo getCommonCSS(); ?></style>
    </head>
    <body>
...
function displayAttendancePage($today, $students, $success_message) {
    ?>
    <!DOCTYPE html>
    <html>
    <head>
            ...
            <?php else: ?>
                <form method="POST">
                    <?php foreach ($students as $index => $student): ?>
                        <?php echo getStudentAttendanceRow($student, $index); ?>
                    <?php endforeach; ?>
...
function getStudentAttendanceRow($student, $index) {
    $student_id = $student['student_id'];
